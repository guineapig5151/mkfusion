...
dataset = 'vod'
root = './data/vod/radar_5frames'
outdir = './data/vod/radar_5frames'
...
def kitti_data_prep(root_path,
    ...
    Args:
        ...
        with_plane (bool, optional): Whether to use plane information.
            Default: False.
    """
    kitti.create_astyx_info_file(root_path)
    ...
    update_pkl_infos('kitti', out_dir= out_dir + 'af', pkl_path=info_train_path)
    update_pkl_infos('kitti', out_dir= out_dir + 'af', pkl_path=info_val_path)
    update_pkl_infos('kitti', out_dir= out_dir + 'af', pkl_path=info_trainval_path)
    update_pkl_infos('kitti', out_dir= out_dir + 'af', pkl_path=info_test_path)
...
def vodlidar_data_prep(root_path,
    ...
    Args:
        ...
        with_plane (bool, optional): Whether to use plane information.
            Default: False.
    """
    vod.create_kitti_info_file(root_path, info_prefix, with_plane, num_features=4)
    vod.create_reduced_point_cloud(root_path, info_prefix, num_features=4)
...
def dualradar_data_prep(root_path,
                    info_prefix,
                    version,
                    out_dir,
                    with_plane=False):
    ...
    Args:
        ...
        with_plane (bool, optional): Whether to use plane information.
            Default: False.
    """
    kitti.create_dualradar_info_file(root_path, info_prefix, with_plane, radar_type='arbe')
