...
def get_radar(idx, name):
    ...
    number_of_channels = 9  # [X, Y, Z, V_r, Range, Power, Alpha, Beta, V_r_comp]
...
train_path = Path('data/tj4d_infos/kitti_infos_val.pkl')
name = 'velodyne_reduced'

root_split_path = Path('data/tj4d/training')
save_path = 'data/seg_label_tj4d_radar/'
...
class_all = ['Car', 'Pedestrian', 'Cyclist', 'Truck', 'Other']

for index in tqdm(range(len(all_frame_ids))):
