...
from .vod_data_utils import WaymoInfoGatherer, get_kitti_image_info
...
def create_reduced_point_cloud(data_path,
    ...
    _create_reduced_point_cloud(data_path, test_info_path, save_path, num_features=num_features)
    if with_back:
        _create_reduced_point_cloud(
            data_path, train_info_path, save_path, back=True, num_features=num_features)
        _create_reduced_point_cloud(
            data_path, val_info_path, save_path, back=True, num_features=num_features)
        _create_reduced_point_cloud(
            data_path, test_info_path, save_path, back=True, num_features=num_features)
