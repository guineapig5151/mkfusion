...
class Pack3DDetInputs(BaseTransform):
    INPUTS_KEYS = ['points', 'img', 'sweep_point_list']
    ...
    def __init__(
        self,
        keys: tuple,
        append_data_sample_keys = ['sweep_point_list'], 
        meta_keys: list = ['img_path', 'ori_shape', 'img_shape', 'lidar2img',
                            ...
                            'depth_map', 'depth_valid_mask']
    ) -> None:
        self.keys = keys
        self.meta_keys = meta_keys + append_data_sample_keys
