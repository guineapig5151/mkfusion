...
class astyxDataset(Seg3DDataset):
    # vod
    METAINFO = {
        'classes': ('background', 'Car', 'Truck', 'Person', 'Towed Object', 'Bus', 'Trailer', 'Other Vehicle', 'Cyclist', 'Motorcyclist'),
        # color for vis
        'palette': [
            (0, 0, 0),  # Index 0
            ...
            (150, 60, 30),  # Index 4: bicycle Brownish 棕色
            (255, 255, 255),  # Index 5: bicycle_rack 白色
            (180, 30, 80),  # Index 6: moped_scooter Dark Pink

            (255, 255, 0),  # Index 7: rider 纯黄
            (255, 255, 255),  # Index 8: human_depiction no_point_in_val
            (122, 139, 139),  # Index 9: truck 浅绿色 

            (90, 30, 150),  # Index 10: ride_other Purple 深紫色
            (66, 66, 66),  # Index 11: motor 灰色
    ...
    def parse_ann_info_vod(self, info: dict) -> dict: # nuscenes cbgs
        name_mapping = {
